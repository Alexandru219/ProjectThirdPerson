...
using UnityEngine.InputSystem;
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public float lookSenseHGamepad = 1.5f;
        public float lookSenseVGamepad = 1.5f;
        public float lookLimitV = 89f;

        [Header("Environment Details")]
        [SerializeField] private LayerMask _groundLayers;

        private InputReaderNew _playerLocomotionInput;
        ...
        private void Awake()
        {
            _playerLocomotionInput = GetComponent<InputReaderNew>();
        ...
        private void LateUpdate()
        {
            ...
            if (TrackerDeviceManager.Instance.CurrentDevice == TrackerDeviceManager.DeviceType.KeyboardMouse)
            {
                yaw += look.x * lookSenseH;
                pitch -= look.y * lookSenseV;
            }else if (TrackerDeviceManager.Instance.CurrentDevice == TrackerDeviceManager.DeviceType.Gamepad)
            {
                yaw += look.x * lookSenseHGamepad;
                pitch -= look.y * lookSenseVGamepad;
            }
